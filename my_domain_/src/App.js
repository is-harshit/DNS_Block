...
import contractAbi0 from './utils/contractABI0.json';
import contractAbi1 from './utils/contractABI1.json';
import contractAbi2 from './utils/contractABI2.json';
import contractAbi3 from './utils/contractABI3.json';

import meta_img from './SVG_holder.json'
...
const arr_nft=['0x5d591b8f344910279FA540Eff81332b9F41EC16e','0x11410cb603CeD424109e57831CB799c6dB58B913',"0x11A6d38c60e017AEd476E957c1af1a4C5cA02F88","0x6EbF98374Ae5E9bdBC74cf0a829fD3c630ed729a"];
const tokenId=0;

const contractABI_arr=[contractAbi0,contractAbi1,contractAbi2,contractAbi3];
  ...
  const Show_confirmation=()=>{
	return(
		<div classname='display_mint'>
			...
			<h2 id='display'><a href={"https://mumbai.polygonscan.com/address/"+CONTRACT_ADDRESS} target="_blank" style={{textDecoration:'none'}} >Record of Transaction</a></h2>  
			{/* <h2 id='display1'><a href={"https://mumbai.polygonscan.com/address/"+CONTRACT_ADDRESS} target="_blank" >Contract Adress</a></h2> */}

			<h2 id='display1'><a href={"https://testnets.opensea.io/assets/mumbai/"+CONTRACT_ADDRESS+'/'+mintcount} target="_blank" style={{textDecoration:'none'}} >Check Minted Domain on OpenSea</a></h2>
	...
	const fetchMints = async () => {
		...
		console.log(mintRecords.length);
		  setMints(mintRecords);
		  mintcount=mintRecords.length;
		//   setflag(true);
		  }
		} catch(error){
		  console.log(error);
	...
	const RenderSelectNFT=()=>{
		...
		return arr_nft.map((val) => {
			return <button className="edit-button" onClick={() =>  Nft_selected(val) }>{
			    <img className="img" src={meta_img[val]} />
				// val	
			}</button>
		  })
		...
		return(
			<div className="Main">
			<div className="Selevt_nft_heading">
				<p style={{color:'#07d6fa',fontSize:'29px'}} className="subtitle">Select your NFT!!</p>
			</div>
			<div style={styles1.root} className="nftdiv">
				{/* <button>Hello</button> */}
			{nft_buttons()}
			</div>
			</div>
